...
if exist "%WINDOW_SCRIPT%" (
  ...
  start "Hi Cream Cliente" "%CHROME_EXE%" %CHROME_NO_TRANSLATE% --app=%CLIENT_URL% %CLIENT_WINDOW%
  timeout /t 2 /nobreak >nul
  start "Hi Cream POS" "%CHROME_EXE%" %CHROME_NO_TRANSLATE% --app=%POS_URL% %POS_WINDOW%
)
